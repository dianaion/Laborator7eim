...
public class XKCDCartoonDisplayerAsyncTask extends AsyncTask<String, Void, XKCDCartoonInformation> {
    ...
    try {
        ...
        httpGet = new HttpGet("http:" + cartoonInternetAddress);
        HttpResponse httpGetResponse = httpClient.execute(httpGet);
        HttpEntity httpGetEntity = httpGetResponse.getEntity();
        Bitmap cartoon = BitmapFactory.decodeStream(httpGetEntity.getContent());
        xkcdCartoonInformation.setCartoonBitmap(cartoon);
